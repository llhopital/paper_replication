function[ys,check]=LCALIB_steadystate(ys,exe)
...
[x,fval]  =   fsolve(@fun_LCALIB,x0,optimset('Display','off','MaxIter',1000,'TolFun',1e-10,'MaxFunEvals',1000));
x0        =   real(x);
[x,fval]  =   fsolve(@fun_LCALIB,x0,optimset('Display','off','MaxIter',1000,'TolFun',1e-10,'MaxFunEvals',1000));
